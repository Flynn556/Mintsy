            ...
            <section className="py-32 px-6 bg-background-alt">
              <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
                  <a href="#" className="p-12 glass rounded-3xl hover:border-gold-primary/50 transition-all group">
                  ...
                  <a href="#" className="p-12 glass rounded-3xl hover:border-gold-secondary/50 transition-all group">
